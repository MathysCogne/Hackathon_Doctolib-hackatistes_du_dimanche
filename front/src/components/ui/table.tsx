...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "m-24 border-b transition-colors hover:bg-neutral-100/50 data-[state=selected]:bg-neutral-100 dark:hover:bg-neutral-800/50 dark:data-[state=selected]:bg-neutral-800",
      className
    )}
    {...props}
  />
